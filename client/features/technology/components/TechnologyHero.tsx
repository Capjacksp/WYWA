...
function MobileTechnologyHero() {
  return (
    <div className="md:hidden">
      <MobileSingleSenseScreen />
      <MobileBlindSpotScreen />
    </div>
  );
}

function MobileSingleSenseScreen() {
  return (
    <section
      data-header-class=""
...
function MobileBlindSpotScreen() {
  return (
    <section
      data-header-class=""
    ...
    >
      ...
      <ScrollTextLines
        as="p"
        className="mt-[54px] font-heading text-[43px] font-[400] uppercase leading-[0.94] tracking-normal text-cta"
        lines={[
          "The result",
          "is a 20-60",
          "minute",
...
function EyeIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <circle cx="46.5" cy="29" r="12" stroke="currentColor" strokeWidth="3" />
    </svg>
  );
}
